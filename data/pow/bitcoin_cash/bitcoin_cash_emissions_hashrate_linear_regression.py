...
for line in open(os.path.join(filepath, 'data', 'bitcoin_cash_hashrate.csv')).readlines()[1:]:
    parts = line.split(',')
    date = parts[0]
...
plt.title('Bitcoin Cash Emissions Hashrate Linear Regression')
plt.xlabel('HashRate(H/s)')
plt.ylabel('Emissions(g)')

plt.show()

# b0: 225.00629710408225 , b1 : [3.93560793e-16], R square : 0.8670736183471788
